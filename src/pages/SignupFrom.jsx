...
//           <div className="flex gap-x-4 text-white-600">
//             <label>
//               <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-richblack-5 text-white">
...
import { sendOtp } from "../apiService/allApiOperation/authApi";
